...
#[derive(Debug)]
pub struct DevKitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DevKitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DevKit processing");
    
    let mut processor = DevKitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DevKitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DevKitProcessor::new(false);
